<script lang="ts">
  ...
  import landing_10 from "./../assets/img_landing_10.png";
...
<main class="relative overflow-x-hidden">
  ...
  >
    ...
    <div
      class="text-left max-w-[964px] lg:max-w-[1240px] w-full m-auto p-14 lg:p-24"
    >
      <h1 class="text text-xl lg:text-2xl text-center">Users said about us</h1>
      <div
      ...
      >
        <div class="card bg-white sm:m-0 px-4 py-6 mb-4 drop-shadow-lg">
        ...
        >
          ...
          <p class="lg:text-lg">
            Love this app! <br class="lg:hidden" />User friendly and helps me
            with all my projects. I bought the subscription for a year, that’s
            how often I use it!<br class="lg:hidden" /><br class="lg:hidden" />
            Before decorating or changing anything in my house, I use this for my
            mock ups!
          </p>
        </div>
        <div class="card bg-white sm:m-0 px-4 py-6 mb-4 drop-shadow-lg">
